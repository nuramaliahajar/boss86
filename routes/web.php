...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('/absensi/manual', 'AbsensiController@manualAbsen')->name('absensi.manual');
    Route::post('/absensi/manual', 'AbsensiController@storeManual')->name('absensi.post_manual');
    ...
    Route::post('/laporan', 'LaporanController@store')->name('laporan.get');
});