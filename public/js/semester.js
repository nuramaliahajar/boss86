...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_sweetalert2__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2_dist_sweetalert2_min_css__ = __webpack_require__(33);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-66f0941d", Component.options)
  } else {
    hotAPI.reload("data-v-66f0941d", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setSort: function setSort(value, sort) {
            this.sort = value;
            if (this.orders == 'asc') {
                this.orders = 'desc';
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c(
      "div",
      {
        staticClass: "col-md-3 offset-md-9",
        staticStyle: { "padding-bottom": "10px" }
      },
      [
        _c("div", { staticClass: "input-group input-group-default" }, [
          _c("input", {
            directives: [
              {
                name: "model",
    ...
    _c("div", { staticClass: "col-md-12" }, [
      _c("div", { staticClass: "box-dt-table table-responsive" }, [
        _c(
          "table",
          { staticClass: "table table-hover table-bordered width-full" },
          [
            _c("thead", [
              _c(
                "tr",
                _vm._l(_vm.columns, function(col) {
                  return _c(
                    "th",
                    {
                      key: col.field,
                      style: [
                        col.sort ? { cursor: "pointer" } : { cursor: "text" }
                      ],
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          _vm.setSort(col.field, col.sort)
                        }
                      }
                    },
                    [
                      ...
                      _c("span", {
                        class: { "icofont icofont-expand-alt": col.sort }
                      })
                    ]
                  )
                })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-66f0941d", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_sweetalert2__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_DataTable_vue__ = __webpack_require__(38);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	data: {
		id_semester: '',
		semester: '',
		columns: [{ title: '#', field: 'id' }, { title: 'Semester', field: 'semester' }, { title: 'Action', filed: 'action' }],
		data: {
			total: 0,
			per_page: 2,
			from: 1,
	...
	methods: {
		...
		sendData: function sendData() {
			...
			this.button = true;
			if (this.id_semester === '') {
				__WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/semester', {
				...
				__WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/semester/update', {
					id: this.id_semester,
					semester: this.semester
				}).then(function (response) {
					setTimeout(function () {
		...
		getData: function getData() {
			...
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/semester?page=' + this.data.current_page + '&q=' + this.q + '&sort=' + this.sort + '&orders=' + this.orders).then(function (response) {
		...
		remove: function remove(id) {
			...
			this.$swal({
				...
				if (result.value) {
					__WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('/api/semester/' + id).then(function (response) {
						_this4.getData();
					}).catch(function (error) {});
				}
			});
