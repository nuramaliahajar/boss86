                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach ($transaksi as $row)
                                @if ($row->sks == 2)
                                    @if ($row->total_hadir == 14)
                                        @php
                                            $persen = '100%';
                                            $ket = 'Baik Sekali';
                                        @endphp
                                    @elseif ($row->total_hadir == 12)
                                        @php
                                            $persen = '80%';
                                            $ket = 'Baik';
                                        @endphp
                                    @elseif ($row->total_hadir == 10)
                                        @php
                                            $persen = '70%';
                                            $ket = 'Kurang';
                                        @endphp
                                    @elseif ($row->total_hadir == 8)
                                        @php
                                            $persen = '60%';
                                            $ket = 'Kurang Baik';
                                        @endphp
                                    ...
                                    @endif
                                @elseif ($row->sks == 4)
                                    @if ($row->total_hadir == 28)
                                        @php
                                            $persen = '100%';
                                            $ket = 'Baik Sekali';
                                        @endphp
                                    @elseif ($row->total_hadir == 24)
                                        @php
                                            $persen = '80%';
                                            $ket = 'Baik';
                                        @endphp
                                    @elseif ($row->total_hadir == 22)
                                        @php
                                            $persen = '70%';
                                            $ket = 'Kurang';
                                        @endphp
                                    @elseif ($row->total_hadir == 20)
                                        @php
                                            $persen = '60%';
                                            $ket = 'Kurang Baik';
                                        @endphp
