				...
				@component('components.panel')
					...
					<form action="#" @submit.prevent="sendData">
						<div class="form-group">
							...
							<input type="text" v-model="kode_kls" class="form-control" required="">
						</div>
						<div class="form-group">
							<label for="">Kelas</label>
							<input type="text" v-model="kelas" class="form-control" required="">
						</div>
							...
							<tr v-for="(row, index) in data.data">
								...
								<td>
									<button class="btn btn-warning btn-sm"
										@click.prevent="edit(row.kode_kls)"
									>
										<i class="fa fa-edit"></i>
									</button>
									<button class="btn btn-danger btn-sm"
										@click.prevent="remove(row.kode_kls)"
										>
